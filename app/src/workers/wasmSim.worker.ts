 ...
 */
// Generated by wasm-pack; run `bun run build:wasm` to regenerate. `app/src/wasm/`
// is gitignored, so a fresh clone/worktree or CI typecheck needs that build
// step before this import resolves — see the "TypeScript typecheck" job in
// .github/workflows/ci.yml, which builds the wasm target first for exactly
// this reason.
