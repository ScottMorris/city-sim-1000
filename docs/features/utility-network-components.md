...
* Per-plant utilization surfaced in the building inspector UI, or any HUD/panel rendering of per-segment stats — the data reaches `GameState` but nothing displays it.
