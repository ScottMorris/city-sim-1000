...
pub fn tool_to_tile_kind(tool: Tool) -> Option<TileKind> {
    match tool {
        ...
        Tool::CoalPlant      => Some(TileKind::HydroPlant), // BUG #30: wrong TileKind, mirrors TS bug for now
        Tool::WindTurbine    => Some(TileKind::HydroPlant), // BUG #30: same
        Tool::SolarFarm      => Some(TileKind::HydroPlant), // BUG #30: same
