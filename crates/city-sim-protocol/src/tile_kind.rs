...
impl TileKind {
    ...
    pub const ALL: &'static [TileKind] = &[
        Self::Land, Self::Water, Self::Tree, Self::Road, Self::Rail,
        Self::Residential, Self::Commercial, Self::Industrial, Self::PowerLine,
        Self::HydroPlant, Self::WaterPump, Self::WaterTower, Self::WaterPipe,
        Self::ElementarySchool, Self::HighSchool, Self::Park,
    ];
